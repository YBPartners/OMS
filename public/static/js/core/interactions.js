// ============================================================
// 다하다 OMS — Interaction Design System v6.0
...
function _renderStatusProgress(currentStatus) {
  const flow = [
    ...
    { key: 'ASSIGNED', short: '배정' },
    { key: 'IN_PROGRESS', short: '작업' },
    { key: 'SUBMITTED', short: '제출' },
...
function renderStatusFlowLarge(currentStatus, history = []) {
  const flow = [
    ...
    { key: 'ASSIGNED', label: '배정완료', icon: 'fa-user-check' },
    { key: 'IN_PROGRESS', label: '작업중', icon: 'fa-wrench' },
    { key: 'SUBMITTED', label: '보고서제출', icon: 'fa-file-lines' },
